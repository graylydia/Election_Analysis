...
<ul><li> Denver clearly had the largest county turnout with 82.8% of voters. We used an if statement to determine that it was the largest turnout. We compared the number of voters and percentages of each county to each other in the if statement. </li></ul>
...
<ul><li> Diana Degette won the election by a landslide. She had 73.8% of voters from the counties which totaled to be 272,892 voters. We determined that she was the winner through an if statement by comparing all of the votes and percentages of each candidate. </li></ul>
